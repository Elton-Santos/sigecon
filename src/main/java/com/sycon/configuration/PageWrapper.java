package com.sycon.configuration;
...
public class PageWrapper<T> {
	...
	public List<T> getConteudo() { return page.getContent(); }

	public boolean isVazia() { return page.getContent().isEmpty(); }
	...
	public int getTotal() { return page.getTotalPages(); }
